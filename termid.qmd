# Term Frequencies by Interview {.unnumbered}

A common task in text mining is examining word frequencies. This involves counting how often each word appears in a collection of text. Analyzing these frequencies can help provide insight of the importance and prevalence of specific terms. Such findings can help identify possible themes and patterns within the text.

There are two frequencies explored in this capstone. The first approach was a straightforward term frequency analysis, counting the words in each interview after removing stopwords, which are commonly used words such as the or is that carry little meaningful content. The second approach examined TF-IDF (term frequency-inverse document frequency), which adjusts these counts by decreasing the weight of words that appear frequently and increasing the weight of words that aren't used much. In essence, TF-IDF measures how important a word is to a document within a larger collection, in this case, to one interview within the entire set of interviews.

When looking at the interviews, we can see that while there is some overlap between term frequency and tf-idf results, the two analyses also highlight different terms. For instance, in Interview ID 18854, the tf-idf analysis identifies retired, programs, section, volunteer, tutoring, and homework as key terms. None of these terms appeared among the five most frequent terms in the term frequency analysis. Based on the tf-idf results, one might hypothesize that this interview focuses on volunteering after retirement, perhaps in a library setting. Looking at the interview description, we can see that this interpretation is pretty close.

Of course, it’s not always so straightforward to guess what an interview is about from this kind of analysis. Take Interview ID 585801, for instance. The terms that come up in both the frequency and tf-idf analyses don’t really match the description. At best, you might say the interview touches on childhood and early memories, and maybe even a hidden passion for magic tricks. This is where we see the limits of computational analysis. While it’s a useful way to get an overview of textual data without diving into the full text, it misses nuances that best come through by actually reading the material.

```{r, echo=FALSE, results='asis'}
cat('<div style="display:flex; flex-direction:column; row-gap:75px;">')
  # INTERVIEW 1
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_1854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_5796.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_11854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_14964.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_15983.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_18854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_20854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_46605.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_60854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_70505.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_70854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_80854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_90854.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_93964.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_371101.svg"))
    cat('</div>')
  ...
  cat('<div style="display:flex; flex-direction:row; align-items:stretch; gap:50px; height:400px;">')
    cat('<div style="flex:1;">')
      cat(xfun::file_string("output/pfin_termid_585801.svg"))
    cat('</div>')
